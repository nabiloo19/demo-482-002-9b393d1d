    ...
    <section id="about" className="relative py-24 md:py-32 px-6 md:px-10 min-h-screen flex items-center">
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <div className="space-y-6 font-body text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          <p>
            <em className="font-heading text-foreground text-lg md:text-xl">Yemenis in Exile</em> is a digital
            storytelling archive that gathers the scattered memories of the Yemeni diaspora. The rituals preserved in
            kitchens abroad, the lullabies hummed in unfamiliar rooms, the textures of a homeland felt across oceans.
          </p>
          <p>
            Through audio recordings, moving images, and written testimonies, this archive becomes a living document of
            displacement, resilience, and the quiet acts of belonging that define a people in exile.
          </p>
          <p>
            Each bubble on the map represents a recurring theme in the archive, a thread connecting individual memories
            into a collective tapestry.
          </p>
          <p>
            Tap a bubble to hear a short memory tied to its theme. When you've heard them all, hit the refresh button
