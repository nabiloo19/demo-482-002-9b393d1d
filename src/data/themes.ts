export interface ThemeBubble {
  ...
  x: number;
  y: number;
  colorVariant: "honey" | "amber" | "saffron" | "sand" | "gold";
  excerpt?: string;
  bannerUrl?: string;
  audioUrl?: string;
  videoUrl?: string;
...
export const themes: ThemeBubble[] = [
  ...
  { id: "dec1", theme: "", frequency: 5, x: 20, y: 35, colorVariant: "honey" },
  { id: "dec2", theme: "", frequency: 4, x: 35, y: 20, colorVariant: "gold" },
  { id: "dec3", theme: "", frequency: 3, x: 62, y: 16, colorVariant: "saffron" },
  { id: "dec4", theme: "", frequency: 5, x: 18, y: 57, colorVariant: "sand" },
  ...
  { id: "dec8", theme: "", frequency: 2, x: 28, y: 68, colorVariant: "honey" },
  { id: "dec9", theme: "", frequency: 3, x: 70, y: 22, colorVariant: "saffron" },
  { id: "dec10", theme: "", frequency: 4, x: 82, y: 60, colorVariant: "sand" },
  { id: "dec11", theme: "", frequency: 3, x: 38, y: 36, colorVariant: "amber" },
  { id: "dec12", theme: "", frequency: 2, x: 66, y: 48, colorVariant: "gold" },
];